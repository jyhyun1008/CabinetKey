            ...
            imgRealUpload.addEventListener('change', function(e) {
                ...
                reader.onloadend = function() {
                    ...
                    .then((imgRes) => {
                        ...
                        document.querySelector('#imgUploader').innerHTML += '<div id="imgUploadFrame'+fileCount+'" onclick="deleteFile(e);" ><span class="bold">'+LANG.ADDFILE+'</span> <span id="imgUpload">'+LANG.CLICK+'</span></div>'
                    })
                    .catch(err => {throw err});
        ...
        .then((notesRes) => {
            ...
            if (mode == 'edit' && isLogin) {
                ...
                for (var i=0; i<notesRes.fileIds.length; i++) {
                    document.querySelector('#imgUploader').innerHTML += '<div id="imgUploadFrame'+i+'" onclick="deleteFile(e);"><span class="bold">'+LANG.ADDFILE+'</span> <span class="imgUploaded" id="imgUploaded'+i+'">'+notesRes.fileIds[i]+'</span></div>'
                }
